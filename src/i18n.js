...
const messages = {
  ...
  resetEmailSent:{ en:'Password reset email sent', da:'E-mail til nulstilling sendt', sv:'Återställningsmejl skickat', es:'Correo de restablecimiento enviado', fr:'E-mail de réinitialisation envoyé', de:'Zurücksetz-E-Mail gesendet' },
  resetEmailError:{ en:'Failed to send reset email', da:'Kunne ikke sende nulstillingsmail', sv:'Misslyckades skicka återställningsmejl', es:'No se pudo enviar el correo', fr:"Échec de l'envoi du mail", de:'Senden der Zurücksetzen-Mail fehlgeschlagen' },
