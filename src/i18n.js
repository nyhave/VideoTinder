...
inviteAccepted:{ en:"Profile created", da:"Oprettet", sv:"Skapad", es:"Perfil creado", fr:"Profil cr\u00e9\u00e9", de:"Profil erstellt" },
  ...
  adminTitle:{ en:'Administration', da:'Administration', sv:'Administration', es:'Administración', fr:'Administration', de:'Administration' },
  dailyAdminTitle:{ en:'Daily administration', da:'Daglig administration', sv:'Daglig administration', es:'Administración diaria', fr:'Administration quotidienne', de:'Tägliche Verwaltung' },
  ...
  reportedContentTitle:{ en:'Reported content', da:'Anmeldt indhold', sv:'Anmält innehåll', es:'Contenido denunciado', fr:'Contenu signalé', de:'Gemeldete Inhalte' },
  statsTitle:{ en:'Statistics', da:'Statistik', sv:'Statistik', es:'Estadísticas', fr:'Statistiques', de:'Statistiken' },
  verificationTitle:{ en:'Verification', da:'Verificering', sv:'Verifiering', es:'Verificación', fr:'Vérification', de:'Verifizierung' },
  troubleshootingTitle:{ en:'Troubleshooting and tests', da:'Fejlsøgning og test', sv:'Felsökning och test', es:'Solución de problemas y pruebas', fr:'Dépannage et tests', de:'Fehlerbehebung und Tests' },
  databaseTitle:{ en:'Database', da:'Database', sv:'Databas', es:'Base de datos', fr:'Base de données', de:'Datenbank' },
  loggingTitle:{ en:'Logging', da:'Logging', sv:'Loggning', es:'Registro', fr:'Journalisation', de:'Protokollierung' },
  hapticFeedbackTitle:{ en:'Haptic feedback', da:'Haptisk feedback', sv:'Haptisk feedback', es:'Retroalimentación háptica', fr:'Retour haptique', de:'Haptisches Feedback' },
  pushNotificationsTitle:{ en:'Push notifications', da:'Push notifications', sv:'Push-notiser', es:'Notificaciones push', fr:'Notifications push', de:'Push-Benachrichtigungen' },
  recentLoginsTitle:{ en:'Recent logins', da:'Seneste logins', sv:'Senaste inloggningar', es:'Inicios de sesión recientes', fr:'Connexions récentes', de:'Letzte Anmeldungen' },
  ...
  revealTestTitle:{ en:'Reveal test', da:'Reveal test', sv:'Reveal-test', es:'Prueba de revelación', fr:'Test reveal', de:'Reveal-Test' },
  graphicsTitle:{ en:'Graphics elements', da:'Grafikelementer', sv:'Grafikelement', es:'Elementos gráficos', fr:'Éléments graphiques', de:'Grafikelemente' },
  pageListTitle:{ en:'Page overview', da:'Sideoversigt', sv:'Sidöversikt', es:'Resumen de páginas', fr:'Aperçu des pages', de:'Seitenübersicht' },
  serverLogTitle:{ en:'Server log', da:'Server log', sv:'Serverlogg', es:'Registro del servidor', fr:'Journal du serveur', de:'Server-Log' },
  likesTitle:{ en:'Who likes you?', da:'Hvem synes om dig?', sv:'Vem gillar dig?', es:'¿A quién le gustas?', fr:'Qui t\'aime ?', de:'Wer mag dich?' },
  textPiecesTitle:{ en:'Text pieces', da:'Tekststykker', sv:'Textstycken', es:'Piezas de texto', fr:'Morceaux de texte', de:'Textstücke' },
  matchLogTitle:{ en:'Match log', da:'Matchlog', sv:'Matchlogg', es:'Registro de coincidencias', fr:'Journal des matchs', de:'Match-Log' },
  scoreLogTitle:{ en:'Score log', da:'Score log', sv:'Poänglogg', es:'Registro de puntuaciones', fr:'Journal des scores', de:'Score-Log' },
  textLogTitle:{ en:'Text log', da:'Tekstlog', sv:'Textlogg', es:'Registro de texto', fr:'Journal des textes', de:'Text-Log' },
  ...
  videoCallTitle:{ en:'Video call', da:'Videoopkald', sv:'Videosamtal', es:'Llamada de video', fr:'Appel vidéo', de:'Videoanruf' },
  premiumTitle:{ en:'Premium', da:'Premium', sv:'Premium', es:'Premium', fr:'Premium', de:'Premium' },
  yourProfileTitle:{ en:'Your profile', da:'Din profil', sv:'Din profil', es:'Tu perfil', fr:'Ton profil', de:'Dein Profil' },
